...
const positions = [
    "Desarrollador", // Posicion de portero
    "Diseñador", // PosiciÃ³n de defensa central
    "Administrador", // PosiciÃ³n de lateral derecho
    "Recepcionista", // PosiciÃ³n de lateral izquierdo
    "Experto en redes", // PosiciÃ³n de mediocampista defensivo
    "Scrum master", // PosiciÃ³n de mediocampista ofensivo
    "Personal de aseo", // PosiciÃ³n de extremo derecho
    "Seguridad", // PosiciÃ³n de extremo izquierdo
...
function loadPositions() {
    ...
    positionSelect.innerHTML = `<option value="">Seleccione una empresa</option>`; // Agrega la opciÃ³n predeterminada
...
function updateTeamSelect() {
    ...
    teamSelect.innerHTML = `<option value="">Seleccione un cargo</option>`; // Agrega la opciÃ³n predeterminada
    teams.forEach(team => {
        const option = document.createElement("option"); // Crea un elemento de opciÃ³n
